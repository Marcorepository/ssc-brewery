...
@Slf4j
public abstract class RestAbstractAuthFilter extends AbstractAuthenticationProcessingFilter {
    public RestAbstractAuthFilter(String defaultFilterProcessesUrl) {
        super(defaultFilterProcessesUrl);
    }

    public RestAbstractAuthFilter(RequestMatcher requiresAuthenticationRequestMatcher) {
